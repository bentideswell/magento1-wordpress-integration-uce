...
/**
 * @category Fishpig
 * @package Fishpig_Wordpress_Addon_UCE
 * @license http://fishpig.co.uk/license.txt
 * @author Ben Tideswell <help@fishpig.co.uk>
 */
	
class Fishpig_Wordpress_Addon_UCE_Helper_License extends Mage_Core_Helper_Abstract
{
	/**
	 ...
	 * @const var string
	 */
	const MODULE_NAME = 'Fishpig_Wordpress_Addon_UCE';
